...
movie_data_path = api.read('dataset/movies.csv', remote='myremote3')
finantial_data_path = api.read('dataset/finantials.csv', remote='myremote3')
opening_data_path = api.read('dataset/opening_gross.csv', remote='myremote3')
